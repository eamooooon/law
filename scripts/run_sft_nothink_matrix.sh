...
DATA_MIX_DIRS="${DATA_MIX_DIRS:-$PROJECT_ROOT/data/sft-en,$PROJECT_ROOT/data/sft-zh}"
...
T1_NAME="${T1_NAME:-t1_full_mix_nothink}"
T2_NAME="${T2_NAME:-t2_lora_mix_nothink}"
T3_NAME="${T3_NAME:-t3_full_en_nothink}"
T4_NAME="${T4_NAME:-t4_lora_en_nothink}"
...
run_train() {
    ...
    echo "=================================================="
    echo "Train: $run_name"
    echo "Data : $train_dirs"
    echo "Out  : $output_dir"
    echo "PEFT : $use_peft"
    echo "Port : $master_port"
    echo "NoThink training: True"
    echo "=================================================="
...
run_train "$T1_NAME" "$DATA_MIX_DIRS" "$FULL_OUTPUT_ROOT/$T1_NAME" "False"
run_eval "$FULL_OUTPUT_ROOT/$T1_NAME" "$RESULT_ROOT/$T1_NAME"

run_train "$T2_NAME" "$DATA_MIX_DIRS" "$LORA_OUTPUT_ROOT/$T2_NAME" "True"
...
echo "=================================================="
echo "All no-think SFT experiments completed."
